...
public class ParhelionBoltSync : MonoBehaviour, INetworkSync
{
    public bool Active { get; private set; }
    public float latency = 0.025f;
    public string Name = "ParhelionBolt";
    float time = 0f;
    Vector3 oldPos;
    Vector3 oldScale;
    Vector3 targetPos;
    ...
    public class BoltData : INetworkEntityData
    {
    ...
    {
        BoltData projData = data as BoltData;
        if (projData != null)
        {
            if (!Active)
            {
            ...
            gameObject.GetComponent<ParhelionBolt>().destroy = projData.destroy;
        }
    }

    public INetworkEntityData Serialize()
    {
        BoltData data = new BoltData()
        {
            ...
            destroy = gameObject.GetComponent<ParhelionBolt>().destroy
        };
        return data;
    }
}
