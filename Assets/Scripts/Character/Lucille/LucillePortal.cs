...
public class LucillePortal : MonoBehaviour
{
	...
	void OnTriggerEnter2D(Collider2D collider)
	{
		...
		try
		{
			...
			{
				rb.velocity = new Vector3(hitbox.Facing * ((hitbox.OverrideData.AngleOfImpact < 45f && hitbox.OverrideData.AngleOfImpact > -30f)?35f:0f),(hitbox.OverrideData.AngleOfImpact > 45f ?35f:(hitbox.OverrideData.AngleOfImpact > 20?0:-35f )),0);
